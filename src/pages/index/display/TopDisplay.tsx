...
export const TopDisplay = () => {
  const setDeletionConfirmation = useSetRecoilState(
  ...
  return (
    <div className="relative pt-2 w-auto h-60">
      <h1 className="text-2xl font-extrabold text-center scale-y-125">
        ポケットモンスター
      </h1>
      <h2 className="mt-1 text-sm font-bold tracking-widest text-center">
        POCKET MONSTERS
      </h2>
      ...
      <button
        onClick={openModal}
        className="absolute right-0 bottom-0 px-1 text-xs rounded border border-gray-700"
      >
        データ削除
      </button>
    </div>
